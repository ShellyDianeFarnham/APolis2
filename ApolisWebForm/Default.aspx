<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ApolisWebForm._Default" %>
...
<script>
    $(document).ready(function () {
        $('.getplaces3').on("click", function () {
            console.log("got to here");a
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("~/default.aspx/getPlaces") %>',
                data: '{ }',
    ...
    /*
        ...
        function initialize() {
            var mapOptions = {
                zoom: 12,
                center: new google.maps.LatLng(47.6201133728027, -122.31616973877),
        ...
        function addMarkers() {
                ...
                for (var i = 0; i < centroidData.length ; i++) {
                    ...
                    var size = Math.floor(centroidData[i][2] * 20);
                    var pinIcon = new google.maps.MarkerImage(
                   "http://www.myiconfinder.com/uploads/iconsets/256-256-c641b2a60054777345c5926858cba213.png",
                    null, /* size is determined at runtime */
                    null, /* origin is 0,0 */
                    new google.maps.Point(10, 0), /* anchor is bottom center of the scaled image */
                    new google.maps.Size(size, size));

                var marker = new google.maps.Marker({
                    position: centroidData[i][0],
                    map: map,
                    title: centroidData[i][1],
                    visible: true,
                    icon: pinIcon
                });
                marker.setMap(map);
        ...
        function getInitialPlaces() {
            console.log("got to initial places");
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("~/default.aspx/getPlaces") %>',
                data: '{ }',
                ...
                success: function (response) {
                    ...
                    $.each(data, function (index, item) {
                        ...
                        if (item.Type != "centroid") {
                            ...
                            var onemarker = [loc, item.DisplayName, item.distnorm];
                            centroidData.push(onemarker);
                        };
                    });
    ...
    console.log("about to get initialplaces");

    getInitialPlaces();


      //  var url = '<%=ResolveUrl("~/default.aspx/getPlaces") %>';
       ...
       //     var dummy = 1;
        //    $.each(data, function (ID, Place) {
         ...
         //   });
            ...
            //making sure data is loaded before initialzing
  ...
  //      });
    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <p>
             <%--<button type="button" class="getplaces3">getplaces3</button>--%>
            </p>
        </div>
        <div class="col-md-4">
                    ...
                    <tr>
                        <td colspan="3" style="text-align:center;" >
                            <div class="page-header">
                                <h2>Where is the best community for me?</h2>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="width:auto;" align="left" >
                            <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                          ...
                                          <asp:TextBox ID="slider1" runat="server" />
                                            ...
                                            <ajaxToolkit:SliderExtender 
                                                ...
                                                Minimum="0"
                                                Maximum="10000"
                                                BoundControlID="lblSlider1BoundControl"                                        
                                                Steps="10000" />

                                            <asp:Label ID="lblSlider1BoundControl" runat="server" ></asp:Label>
                                ...
                                <tr>
                                    <td width="100%">--%>
                                        <%--<asp:DropDownList ID="ddlICanAfford" runat="server">
                                            <asp:ListItem Value="">400 - 600</asp:ListItem>
                                            <asp:ListItem Value="">600 - 800</asp:ListItem>
                                            <asp:ListItem Value="">800 - 1000</asp:ListItem>
                                            <asp:ListItem Value="">1000 - 1200</asp:ListItem>
                                            <asp:ListItem Value="">1200 - 1400</asp:ListItem>
                                            <asp:ListItem Value="">1400 - 1600</asp:ListItem>
                                        </asp:DropDownList>--%>
...
<%--                                        <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    ...
    --%>                                                
                                ...
                                <tr>
                                    <td width="100%">
                                        <div class="panel-body">--%>
                                            ...
                                            I want to live near:
                                            <br />
                                         <asp:DropDownList ID="ddlNeighborhood" runat="server">
                                            <asp:ListItem Value="0">-- Select one --</asp:ListItem>
                                            <asp:ListItem Value="1"  >Adams</asp:ListItem>
                                            <asp:ListItem Value="2"  >Algona</asp:ListItem>
                                            <asp:ListItem Value="3"  >Alki</asp:ListItem>
                                            <asp:ListItem Value="4"  >Ames Lake</asp:ListItem>
                                            <asp:ListItem Value="5"  >Arbor Heights</asp:ListItem>
                                            <asp:ListItem Value="6"  >Auburn::</asp:ListItem>
                                            <asp:ListItem Value="7"  >Avondale</asp:ListItem>
                                            <asp:ListItem Value="8"  >Ballard</asp:ListItem>
                                            <asp:ListItem Value="9"  >Beacon Hill</asp:ListItem>
                                            <asp:ListItem Value="10"  >Beaux Arts</asp:ListItem>
                                            <asp:ListItem Value="11"  >Beaver Lake</asp:ListItem>
                                            <asp:ListItem Value="12"  >Bellevue</asp:ListItem>
                                            <asp:ListItem Value="13"  >Belltown</asp:ListItem>
                                            <asp:ListItem Value="14"  >Benson</asp:ListItem>
                                            <asp:ListItem Value="15"  >Bitter Lake</asp:ListItem>
                                            <asp:ListItem Value="16"  >Black Diamond</asp:ListItem>
                                            <asp:ListItem Value="17"  >Bothell</asp:ListItem>
                                            <asp:ListItem Value="18"  >Boulevard Park</asp:ListItem>
                                            <asp:ListItem Value="19"  >Briarcliff</asp:ListItem>
                                            <asp:ListItem Value="20"  >Bridle Trails</asp:ListItem>
                                            <asp:ListItem Value="21"  >Brighton</asp:ListItem>
                                            <asp:ListItem Value="22"  >Broadview</asp:ListItem>
                                            <asp:ListItem Value="23"  >Broadway</asp:ListItem>
                                            <asp:ListItem Value="24"  >Bryant</asp:ListItem>
                                            <asp:ListItem Value="25"  >Bryn Mawr</asp:ListItem>
                                            <asp:ListItem Value="26"  >Burien</asp:ListItem>
                                            <asp:ListItem Value="27"  >Capitol Hill</asp:ListItem>
                                            <asp:ListItem Value="28"  >Carnation</asp:ListItem>
                                            <asp:ListItem Value="29"  >Cascade</asp:ListItem>
                                            <asp:ListItem Value="30"  >Cedar River</asp:ListItem>
                                            <asp:ListItem Value="31"  >Central District</asp:ListItem>
                                            <asp:ListItem Value="32"  >Central Houghton</asp:ListItem>
                                            <asp:ListItem Value="33"  >Clyde Hill</asp:ListItem>
                                            <asp:ListItem Value="34"  >Columbia City</asp:ListItem>
                                            <asp:ListItem Value="35"  >Cottage Lake</asp:ListItem>
                                            <asp:ListItem Value="36"  >Cougar Mountain</asp:ListItem>
                                            <asp:ListItem Value="37"  >Covington</asp:ListItem>
                                            <asp:ListItem Value="38"  >Crossroads</asp:ListItem>
                                            <asp:ListItem Value="39"  >Delridge</asp:ListItem>
                                            <asp:ListItem Value="40"  >Des Moines</asp:ListItem>
                                            <asp:ListItem Value="41"  >Dunlap</asp:ListItem>
                                            <asp:ListItem Value="42"  >Duvall</asp:ListItem>
                                            <asp:ListItem Value="43"  >East Plateau</asp:ListItem>
                                            <asp:ListItem Value="44"  >Eastgate</asp:ListItem>
                                            <asp:ListItem Value="45"  >Education Hill</asp:ListItem>
                                            <asp:ListItem Value="46"  >Enumclaw</asp:ListItem>
                                            <asp:ListItem Value="47"  >Factoria</asp:ListItem>
                                            <asp:ListItem Value="48"  >Fairmont Park</asp:ListItem>
                                            <asp:ListItem Value="49"  >Fairwood</asp:ListItem>
                                            <asp:ListItem Value="50"  >Fall City</asp:ListItem>
                                            <asp:ListItem Value="51"  >Fauntleroy</asp:ListItem>
                                            <asp:ListItem Value="52"  >Federal Way</asp:ListItem>
                                            <asp:ListItem Value="53"  >Finn Hill</asp:ListItem>
                                            <asp:ListItem Value="54"  >Fremont</asp:ListItem>
                                            <asp:ListItem Value="55"  >Genesee</asp:ListItem>
                                            <asp:ListItem Value="56"  >Georgetown</asp:ListItem>
                                            <asp:ListItem Value="57"  >Grass Lawn Park</asp:ListItem>
                                            <asp:ListItem Value="58"  >Green Lake</asp:ListItem>
                                            <asp:ListItem Value="59"  >Greenwood</asp:ListItem>
                                            <asp:ListItem Value="60"  >Haller Lake</asp:ListItem>
                                            <asp:ListItem Value="61"  >High Point</asp:ListItem>
                                            <asp:ListItem Value="62"  >Highland Crossing</asp:ListItem>
                                            <asp:ListItem Value="63"  >Highland Park</asp:ListItem>
                                            <asp:ListItem Value="64"  >Highlands</asp:ListItem>
                                            <asp:ListItem Value="65"  >Holly Park</asp:ListItem>
                                            <asp:ListItem Value="66"  >Hollywood Hill</asp:ListItem>
                                            <asp:ListItem Value="67"  >Idylwood</asp:ListItem>
                                            <asp:ListItem Value="68"  >Industrial District</asp:ListItem>
                                            <asp:ListItem Value="69"  >Inglewood</asp:ListItem>
                                            <asp:ListItem Value="70"  >Interbay</asp:ListItem>
                                            <asp:ListItem Value="71"  >International District</asp:ListItem>
                                            <asp:ListItem Value="72"  >Issaquah</asp:ListItem>
                                            <asp:ListItem Value="73"  >Issaquah Highlands</asp:ListItem>
                                            <asp:ListItem Value="74"  >Juanita</asp:ListItem>
                                            <asp:ListItem Value="75"  >Kenmore</asp:ListItem>
                                            <asp:ListItem Value="76"  >Kennydale</asp:ListItem>
                                            <asp:ListItem Value="77"  >Kent</asp:ListItem>
                                            <asp:ListItem Value="78"  >Kenton Firs</asp:ListItem>
                                            <asp:ListItem Value="79"  >Kingsgate</asp:ListItem>
                                            <asp:ListItem Value="80"  >Kirkland</asp:ListItem>
                                            <asp:ListItem Value="81"  >Klahanie</asp:ListItem>
                                            <asp:ListItem Value="82"  >Lake City</asp:ListItem>
                                            <asp:ListItem Value="83"  >Lake Forest Park</asp:ListItem>
                                            <asp:ListItem Value="84"  >Lake Hills</asp:ListItem>
                                            <asp:ListItem Value="85"  >Lake Meridian</asp:ListItem>
                                            <asp:ListItem Value="86"  >Lake Sammamish</asp:ListItem>
                                            <asp:ListItem Value="87"  >Lake Tradition</asp:ListItem>
                                            <asp:ListItem Value="88"  >Lakeview</asp:ListItem>
                                            <asp:ListItem Value="89"  >Laurelhurst</asp:ListItem>
                                            <asp:ListItem Value="90"  >Lawtow Park</asp:ListItem>
                                            <asp:ListItem Value="91"  >Leota - Reinwood</asp:ListItem>
                                            <asp:ListItem Value="92"  >Leschi</asp:ListItem>
                                            <asp:ListItem Value="93"  >Loyal Heights</asp:ListItem>
                                            <asp:ListItem Value="94"  >Madison Park</asp:ListItem>
                                            <asp:ListItem Value="95"  >Madrona</asp:ListItem>
                                            <asp:ListItem Value="96"  >Magnolia</asp:ListItem>
                                            <asp:ListItem Value="97"  >Mann</asp:ListItem>
                                            <asp:ListItem Value="98"  >Maple Leaf</asp:ListItem>
                                            <asp:ListItem Value="99"  >Maple Valley</asp:ListItem>
                                            <asp:ListItem Value="100"  >Market</asp:ListItem>
                                            <asp:ListItem Value="101"  >Meadowbrook</asp:ListItem>
                                            <asp:ListItem Value="102"  >Medina</asp:ListItem>
                                            <asp:ListItem Value="103"  >Mercer Island:Mid Island:</asp:ListItem>
                                            <asp:ListItem Value="104"  >Mercer Island:North End:</asp:ListItem>
                                            <asp:ListItem Value="105"  >Mercer Island:South End:</asp:ListItem>
                                            <asp:ListItem Value="106"  >Meridian Glen</asp:ListItem>
                                            <asp:ListItem Value="107"  >Mill Creek</asp:ListItem>
                                            <asp:ListItem Value="108"  >Milton</asp:ListItem>
                                            <asp:ListItem Value="109"  >Minor</asp:ListItem>
                                            <asp:ListItem Value="110"  >Montlake</asp:ListItem>
                                            <asp:ListItem Value="111"  >Montreux</asp:ListItem>
                                            <asp:ListItem Value="112"  >Moss Bay</asp:ListItem>
                                            <asp:ListItem Value="113"  >Mount Baker</asp:ListItem>
                                            <asp:ListItem Value="114"  >Mount View</asp:ListItem>
                                            <asp:ListItem Value="115"  >Newcastle</asp:ListItem>
                                            <asp:ListItem Value="116"  >Newport</asp:ListItem>
                                            <asp:ListItem Value="117"  >Normandy Park</asp:ListItem>
                                            <asp:ListItem Value="118"  >North Admiral</asp:ListItem>
                                            <asp:ListItem Value="119"  >North Beach</asp:ListItem>
                                            <asp:ListItem Value="120"  >North Bend</asp:ListItem>
                                            <asp:ListItem Value="121"  >North Burien</asp:ListItem>
                                            <asp:ListItem Value="122"  >North College Park</asp:ListItem>
                                            <asp:ListItem Value="123"  >North End</asp:ListItem>
                                            <asp:ListItem Value="124"  >North Issquah</asp:ListItem>
                                            <asp:ListItem Value="125"  >North Park</asp:ListItem>
                                            <asp:ListItem Value="126"  >North Redmond</asp:ListItem>
                                            <asp:ListItem Value="127"  >Northeast Bellevue</asp:ListItem>
                                            <asp:ListItem Value="128"  >Northgate</asp:ListItem>
                                            <asp:ListItem Value="129"  >Northwest Bellevue</asp:ListItem>
                                            <asp:ListItem Value="130"  >Novelty Hill</asp:ListItem>
                                            <asp:ListItem Value="131"  >Overlake</asp:ListItem>
                                            <asp:ListItem Value="132"  >Pacific</asp:ListItem>
                                            <asp:ListItem Value="133"  >Panther Lake</asp:ListItem>
                                            <asp:ListItem Value="134"  >Phinney Ridge</asp:ListItem>
                                            <asp:ListItem Value="135"  >Pike Market</asp:ListItem>
                                            <asp:ListItem Value="136"  >Pine Lake</asp:ListItem>
                                            <asp:ListItem Value="137"  >Pinehurst</asp:ListItem>
                                            <asp:ListItem Value="138"  >Pioneer Square</asp:ListItem>
                                            <asp:ListItem Value="139"  >Queen Anne</asp:ListItem>
                                            <asp:ListItem Value="140"  >Rainier Valley</asp:ListItem>
                                            <asp:ListItem Value="141"  >Ravenna</asp:ListItem>
                                            <asp:ListItem Value="142"  >Ravensdale</asp:ListItem>
                                            <asp:ListItem Value="143"  >Redmond</asp:ListItem>
                                            <asp:ListItem Value="144"  >Renton</asp:ListItem>
                                            <asp:ListItem Value="145"  >Riverview</asp:ListItem>
                                            <asp:ListItem Value="146"  >Roosevelt</asp:ListItem>
                                            <asp:ListItem Value="147"  >Rose Hill</asp:ListItem>
                                            <asp:ListItem Value="148"  >Roxhill</asp:ListItem>
                                            <asp:ListItem Value="149"  >Sahalee</asp:ListItem>
                                            <asp:ListItem Value="150"  >Salt Air Hills</asp:ListItem>
                                            <asp:ListItem Value="151"  >Sammamish</asp:ListItem>
                                            <asp:ListItem Value="152"  >Sammamish Plateau</asp:ListItem>
                                            <asp:ListItem Value="153"  >Seahurst</asp:ListItem>
                                            <asp:ListItem Value="154"  >Seatac</asp:ListItem>
                                            <asp:ListItem Value="155"  >Seattle</asp:ListItem>
                                            <asp:ListItem Value="156"  >Seaview</asp:ListItem>
                                            <asp:ListItem Value="157"  >Seola Beach</asp:ListItem>
                                            <asp:ListItem Value="158"  >Seward Park</asp:ListItem>
                                            <asp:ListItem Value="159"  >Shoreline</asp:ListItem>
                                            <asp:ListItem Value="160"  >Skykomish</asp:ListItem>
                                            <asp:ListItem Value="161"  >Skyway</asp:ListItem>
                                            <asp:ListItem Value="162"  >Snoqualmie::</asp:ListItem>
                                            <asp:ListItem Value="163"  >Sodo</asp:ListItem>
                                            <asp:ListItem Value="164"  >Somerset</asp:ListItem>
                                            <asp:ListItem Value="165"  >South Lake Union</asp:ListItem>
                                            <asp:ListItem Value="166"  >South Park</asp:ListItem>
                                            <asp:ListItem Value="167"  >Southeast Redmond</asp:ListItem>
                                            <asp:ListItem Value="168"  >Southern</asp:ListItem>
                                            <asp:ListItem Value="169"  >Squak Mountain</asp:ListItem>
                                            <asp:ListItem Value="170"  >Sunnydale</asp:ListItem>
                                            <asp:ListItem Value="171"  >Sunset Hill</asp:ListItem>
                                            <asp:ListItem Value="172"  >Talbot</asp:ListItem>
                                            <asp:ListItem Value="173"  >The Lakes</asp:ListItem>
                                            <asp:ListItem Value="174"  >Totem Lake</asp:ListItem>
                                            <asp:ListItem Value="175"  >Tukwila</asp:ListItem>
                                            <asp:ListItem Value="176"  >Union Hill</asp:ListItem>
                                            <asp:ListItem Value="177"  >University District</asp:ListItem>
                                            <asp:ListItem Value="178"  >Valley</asp:ListItem>
                                            <asp:ListItem Value="179"  >Vashon</asp:ListItem>
                                            <asp:ListItem Value="180"  >Victory Heights</asp:ListItem>
                                            <asp:ListItem Value="181"  >View Ridge</asp:ListItem>
                                            <asp:ListItem Value="182"  >Wallingford</asp:ListItem>
                                            <asp:ListItem Value="183"  >Wedgewood</asp:ListItem>
                                            <asp:ListItem Value="184"  >West Bellevue</asp:ListItem>
                                            <asp:ListItem Value="185"  >West Hill</asp:ListItem>
                                            <asp:ListItem Value="186"  >West Ridge</asp:ListItem>
                                            <asp:ListItem Value="187"  >West Seattle</asp:ListItem>
                                            <asp:ListItem Value="188"  >Westlake</asp:ListItem>
                                            <asp:ListItem Value="189"  >White Center</asp:ListItem>
                                            <asp:ListItem Value="190"  >Whittier Heights</asp:ListItem>
                                            <asp:ListItem Value="191"  >Wilburton</asp:ListItem>
                                            <asp:ListItem Value="192"  >Willows - Rose Hill</asp:ListItem>
                                            <asp:ListItem Value="193"  >Woodinville</asp:ListItem>
                                            <asp:ListItem Value="194"  >Woodridge</asp:ListItem>
                                            <asp:ListItem Value="195"  >Yesler Terrace</asp:ListItem>
                                        </asp:DropDownList>
                                            ...
                                            <asp:CheckBox ID="chkBestCommunity" runat="server" />&nbsp;Show Best Community Hubs
                                        
                                            <br />
                                            <br />

                                            Where people like me live:
                                            <asp:DropDownList ID="ddlPeopleLikeMe" runat="server" >

                                                <asp:ListItem Selected="True" Value="0">-- Select one --</asp:ListItem>
                                                <asp:ListItem Value="1">Median-Income Family</asp:ListItem>
                                                <asp:ListItem Value="2">Very Low-Income Individual</asp:ListItem>
                                                <asp:ListItem Value="3">Working Individual</asp:ListItem>
                                                <asp:ListItem Value="4">Single Professional</asp:ListItem>

                                                <asp:ListItem Value="5">Retired Couple</asp:ListItem>
                                                <asp:ListItem Value="6">Single-Parent Family</asp:ListItem>
                                                <asp:ListItem Value="7">Moderate-Income Family</asp:ListItem>
                                                <asp:ListItem Value="8">Dual-Professional Family</asp:ListItem>
                        ...
                        <td >
                            <div id="map-canvas" style="height: 530px; width:400px;"></div>            
                        </td>
                    </tr>
                </table>
